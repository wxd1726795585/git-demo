 ...
 */
@Data
public class ShopAssistantTrainReq {
    /**
     * 培训日期
     */
     ...
     * 关联药店
     */
    @NotBlank(message = "关联药店不能为空")
    @Length(min = 1, max = 30, message = "关联药店最多30个字")
    private String affiliatedPharmacy;
    /**
     * 培训地点
     */
    @NotBlank(message = "培训地点不能为空")
    @Length(min = 1, max = 60, message = "培训地点最多60个字")
